      ...
      <div className="items-container">
        ...
        <VerticalTimeline>
          ...
          >
            ...
            <p>
              Focus: Network Security, Security Testing, Cybersecurity Risk Assessment, Distributed Systems
            </p>
          </VerticalTimelineElement>
          <VerticalTimelineElement
            className="vertical-timeline-element--education"
          ...
          >
            ...
            <p>
              Focus: Algorithms, Data Structure, Operating Systems, Database Systems, Object-Oriented Programming
            </p>
          </VerticalTimelineElement>
          <VerticalTimelineElement
